# ===============================================
# Análise de Sentimentos - Modelo Tabularisai
...
saida = "resultados/resultados_sentimentos-model-tabularisai.csv"
...
# Normalizar as 5 classes para 3 categorias pra deixar padrão, incluindo o erro
def simplificar_sentimento(label):
...
# Criar nova coluna com classificação simplificada
df_resultados["Sentiment_3class"] = df_resultados["Sentiment"].apply(simplificar_sentimento)
